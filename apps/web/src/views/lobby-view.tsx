import { clearAuthentication, createGame, joinGame, selectHasGame, selectHasPlayer } from '@cah/store';
...
export default function LobbyView() {
  ...
  const handleLogOut = () => {
    void store.dispatch(clearAuthentication());
  };
...
function CreateGame() {
  return (
    ...
    >
      <button class="btn text-large">Create game</button>
      <p>
  ...
  return (
    ...
    >
      <div class="row items-end gap-4">
        ...
        <button class="btn text-large">Join game</button>
      </div>
