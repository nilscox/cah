...
const mapStateToProps = (state) => ({
  question: selectors.gameQuestion(state),
  cards: selectors.playerCards(state),
  selectedChoices: selectors.playerSelectedChoices(state),
  submittedAnswer: selectors.playerSubmittedAnswer(state),
  isSelected: selectors.playerIsChoiceSelected(state),
  canToggleChoice: selectors.playerCanToggleChoice(state),
  canSubmitAnswer: selectors.playerCanSubmitAnswer(state),
});

const mapDispatchToProps = (dispatch: Function) => ({
  toggleChoice: (choice) => dispatch(toggleChoice(choice)),
  submitAnswer: (choices) => dispatch(submitAnswer(choices)),
});
    ...
    <View style={styles.wrapper}>
      ...
      <View style={styles.question}>
        <QuestionCard
          ...
          onPress={() => canSubmitAnswer && submitAnswer(selectedChoices)}
        />
      </View>
